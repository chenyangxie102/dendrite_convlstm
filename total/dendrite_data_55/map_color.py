...
# # 设置路径
# data_dir = 'test'
# output_dir = 'test_color_1'
#
# # data_dir = 'result_trans/dendrite_convlstm_12_star'
# # output_dir = 'result_trans/dendrite_convlstm_12_star_color_1'
# num_samples = 12
# num_imgs_per_sample = 50
#
# # 创建输出目录
...
#
#     for img_idx in range(1, num_imgs_per_sample + 1):
...
#             rgb_image[mask_non_zero] = (1 - img_array[mask_non_zero][:, None]) * white + img_array[mask_non_zero][:, None] * aqua_blue
#             # 保存RGB图像
